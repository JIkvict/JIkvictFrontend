...
public val MyIconPack.Taskstatusfailedlight: ImageVector
    get() {
        ...
        _taskstatusfailedlight = Builder(
            name = "Taskstatusfailedlight", defaultWidth = 16.0.dp,
            defaultHeight = 16.0.dp, viewportWidth = 16.0f, viewportHeight = 16.0f
        ).apply {
            path(
                fill = SolidColor(Color(0xFFFFF7F7)), stroke = SolidColor(Color(0xFFDB3B4B)),
            ...
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFFDB3B4B)),
