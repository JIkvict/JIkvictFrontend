...
public val MyIconPack.Taskstatuslight: ImageVector
    get() {
        if (_taskstatuslight != null) {
            return _taskstatuslight!!
        }
        _taskstatuslight = Builder(
            name = "Taskstatuslight", defaultWidth = 16.0.dp, defaultHeight =
                16.0.dp, viewportWidth = 16.0f, viewportHeight = 16.0f
        ).apply {
            path(
                fill = SolidColor(Color(0xFFEBECF0)), stroke = SolidColor(Color(0xFF6C707E)),
...
private var _taskstatuslight: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MyIconPack.Taskstatuslight, contentDescription = "")
    }
}
