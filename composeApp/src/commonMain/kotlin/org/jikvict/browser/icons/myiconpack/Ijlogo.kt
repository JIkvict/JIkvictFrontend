...
public val MyIconPack.Ijlogo: ImageVector
    get() {
        if (_ijlogo != null) {
            return _ijlogo!!
        }
        _ijlogo = Builder(
            name = "Ijlogo", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            viewportWidth = 24.0f, viewportHeight = 24.0f
        ).apply {
            path(
                fill = SolidColor(Color(0xFFA177F4)), stroke = null, strokeLineWidth = 0.0f,
            ...
            path(
                fill = SolidColor(Color(0xFFDB5C5C)), stroke = null, strokeLineWidth = 0.0f,
                strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                pathFillType = NonZero
            ) {
                moveTo(3.5f, 11.5f)
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MyIconPack.Ijlogo, contentDescription = "")
    }
}
