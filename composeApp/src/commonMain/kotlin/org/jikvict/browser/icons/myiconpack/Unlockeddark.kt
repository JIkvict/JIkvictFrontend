...
val MyIconPack.Unlockeddark: ImageVector
    get() {
        if (_unlockeddark != null) {
            return _unlockeddark!!
        }
        _unlockeddark = Builder(name = "Unlockeddark", defaultWidth = 16.0.dp, defaultHeight =
...
private var _unlockeddark: ImageVector? = null
