...
public val MyIconPack.Taskstatusdark: ImageVector
    get() {
        if (_taskstatusdark != null) {
            return _taskstatusdark!!
        }
        _taskstatusdark = Builder(name = "Taskstatusdark", defaultWidth = 16.0.dp, defaultHeight =
                16.0.dp, viewportWidth = 16.0f, viewportHeight = 16.0f).apply {
            path(fill = SolidColor(Color(0xFF43454A)), stroke = SolidColor(Color(0xFFCED0D6)),
...
private var _taskstatusdark: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MyIconPack.Taskstatusdark, contentDescription = "")
    }
}
