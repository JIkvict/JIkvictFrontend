...
public val MyIconPack.Taskstatusdonedark: ImageVector
    get() {
        if (_taskstatusdonedark != null) {
            return _taskstatusdonedark!!
        }
        _taskstatusdonedark = Builder(name = "Taskstatusdonedark", defaultWidth = 16.0.dp,
                defaultHeight = 16.0.dp, viewportWidth = 16.0f, viewportHeight = 16.0f).apply {
            path(fill = SolidColor(Color(0xFF253627)), stroke = SolidColor(Color(0xFF57965C)),
...
private var _taskstatusdonedark: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MyIconPack.Taskstatusdonedark, contentDescription = "")
    }
}
