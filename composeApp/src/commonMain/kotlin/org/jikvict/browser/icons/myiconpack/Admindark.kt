...
public val Admindark: ImageVector
    get() {
        if (_admindark != null) {
            return _admindark!!
        }
        _admindark = Builder(
            name = "Admindark", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            viewportWidth = 16.0f, viewportHeight = 16.0f
        ).apply {
            path(
                fill = SolidColor(Color(0xFF548AF7)), stroke = null, strokeLineWidth = 0.0f,
...
private var _admindark: ImageVector? = null
